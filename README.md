...
The abstract (below) provides the insight to the research that has been performed. The additional Jupyter notebook with included entitled 050125_DailySupportingWaterBudget_M2_Revisions provides supporting analysis associated with the manuscript supported by this research. 
